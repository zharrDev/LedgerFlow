...
payments.post("/subscribe", authMiddleware, async (c) => {
  ...
  try {
    ...
    return c.json({ error: "Gagal membuat pembayaran. Coba lagi beberapa saat." }, 500);
  }
});
...
payments.post("/test-complete", authMiddleware, async (c) => {
  ...
  try {
    ...
    return c.json({ error: "Gagal menyelesaikan pembayaran uji. Coba lagi beberapa saat." }, 500);
  }
});
