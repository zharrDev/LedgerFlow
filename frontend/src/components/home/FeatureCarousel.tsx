  ...
  return (
    <section className="py-20 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* Track gulir — sempit dengan ruang lega kiri-kanan, tidak mentok pinggir */}
          <div className="relative mx-auto w-[70%] sm:w-[66%] lg:w-[62%] h-[300px] sm:h-[400px] lg:h-[480px] overflow-hidden">
            {renderKeys.map((k) => {
            ...
            <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[88%] h-full z-10">
