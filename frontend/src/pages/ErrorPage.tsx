...
const errorConfig: Record<string, ErrorEntry> = {
  "401": { icon: Lock, color: "text-orange-500", title: { en: "Not Signed In", id: "Belum Login" }, desc: { en: "Please sign in first to access this page.", id: "Silakan login terlebih dahulu untuk mengakses halaman ini." } },
  "403": { icon: ShieldAlert, color: "text-red-500", title: { en: "Access Denied", id: "Akses Ditolak" }, desc: { en: "You do not have permission to access this page.", id: "Anda tidak memiliki izin untuk mengakses halaman ini." } },
  "404": { icon: AlertTriangle, color: "text-yellow-500", title: { en: "Page Not Found", id: "Halaman Tidak Ditemukan" }, desc: { en: "The page you are looking for does not exist.", id: "Halaman yang Anda cari tidak ada." } },
